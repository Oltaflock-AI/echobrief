 ...
 *
 * A signed-out visitor has no `profiles` row, so the flag that picks V2 for
 * every other page cannot see them: this renders only under the `?ui=v2`
 * override until V1 auth is deleted.
 *
