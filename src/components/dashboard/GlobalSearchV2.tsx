 ...
 *
 * The reads are V1's: meeting titles, transcript bodies, the action items
 * inside meeting_insights, plus contacts (a table the old palette never
 * searched). Nothing new is indexed and no endpoint was added.
 *
